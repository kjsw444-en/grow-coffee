...
test('방치만으로 display 100% 가능 — state는 서버 settle 전 75%', () => {
  const state = 75;
...
test('방치 게이지는 100%까지 도달 가능', () => {
  assert.equal(previewPassiveDisplayGrowth(50, 50), 100);
